...
impl Transformer {
    ...
    fn process_block(&self, 
        ...
        let attn_output_weight = tensor_cache.get(&attn_output_weight_name)
        ...
        let ffn_norm_weight = tensor_cache.get(&ffn_norm_weight_name)
        ...
        let normalized_for_ffn = self.rms_norm(&residual_after_attn, ffn_norm_weight)?;
